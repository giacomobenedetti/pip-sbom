...
from pip._vendor import boolean
from pip._vendor.boolean import Expression as LicenseExpression

# note these may not all be used here but are imported here to avoid leaking
# boolean.py constants to callers
from pip._vendor.boolean.boolean import PARSE_ERRORS
from pip._vendor.boolean.boolean import PARSE_INVALID_EXPRESSION
from pip._vendor.boolean.boolean import PARSE_INVALID_NESTING
from pip._vendor.boolean.boolean import PARSE_INVALID_OPERATOR_SEQUENCE
from pip._vendor.boolean.boolean import PARSE_INVALID_SYMBOL_SEQUENCE
from pip._vendor.boolean.boolean import PARSE_UNBALANCED_CLOSING_PARENS
from pip._vendor.boolean.boolean import PARSE_UNKNOWN_TOKEN

from pip._vendor.boolean.boolean import ParseError
from pip._vendor.boolean.boolean import TOKEN_SYMBOL
from pip._vendor.boolean.boolean import TOKEN_AND
from pip._vendor.boolean.boolean import TOKEN_OR
from pip._vendor.boolean.boolean import TOKEN_LPAR
from pip._vendor.boolean.boolean import TOKEN_RPAR

from pip._vendor.license_expression._pyahocorasick import Trie as AdvancedTokenizer
from pip._vendor.license_expression._pyahocorasick import Token
