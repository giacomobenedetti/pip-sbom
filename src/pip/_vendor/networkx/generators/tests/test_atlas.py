...
from pip._vendor.networkx import graph_atlas, graph_atlas_g
from pip._vendor.networkx.generators.atlas import NUM_GRAPHS
from pip._vendor.networkx.utils import edges_equal, nodes_equal, pairwise
