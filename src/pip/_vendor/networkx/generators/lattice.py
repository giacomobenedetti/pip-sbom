...
from pip._vendor.networkx.classes import set_node_attributes
from pip._vendor.networkx.exception import NetworkXError
from pip._vendor.networkx.generators.classic import cycle_graph, empty_graph, path_graph
from pip._vendor.networkx.relabel import relabel_nodes
from pip._vendor.networkx.utils import flatten, nodes_or_number, pairwise
...
def grid_graph(dim, periodic=False):
    ...
    6
    """
    from pip._vendor.networkx.algorithms.operators.product import cartesian_product
...
def triangular_lattice_graph(
    ...
    from pip._vendor.networkx.algorithms.minors import contracted_nodes
