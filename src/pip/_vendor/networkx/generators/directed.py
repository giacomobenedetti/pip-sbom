...
from pip._vendor.networkx.generators.classic import empty_graph
from pip._vendor.networkx.utils import discrete_sequence, py_random_state, weighted_choice
