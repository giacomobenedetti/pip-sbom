...
from pip._vendor.networkx.algorithms.approximation import k_components
from pip._vendor.networkx.algorithms.approximation.kcomponents import _AntiGraph, _same
