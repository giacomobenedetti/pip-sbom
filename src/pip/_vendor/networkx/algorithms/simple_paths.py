...
from pip._vendor.networkx.algorithms.shortest_paths.weighted import _weight_function
from pip._vendor.networkx.utils import not_implemented_for, pairwise
