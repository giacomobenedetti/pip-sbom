...
from pip._vendor.networkx.algorithms.connectivity import EdgeComponentAuxGraph, bridge_components
from pip._vendor.networkx.algorithms.connectivity.edge_kcomponents import general_k_edge_subgraphs
from pip._vendor.networkx.utils import pairwise
