...
from pip._vendor.networkx import barbell_graph
from pip._vendor.networkx.algorithms.community import modularity, partition_quality
from pip._vendor.networkx.algorithms.community.quality import inter_community_edges
