...
from pip._vendor.networkx import NetworkXError
from pip._vendor.networkx.algorithms.community.community_utils import is_partition
from pip._vendor.networkx.utils.decorators import argmap
