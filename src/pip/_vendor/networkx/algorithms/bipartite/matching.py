...
from pip._vendor.networkx.algorithms.bipartite import sets as bipartite_sets
from pip._vendor.networkx.algorithms.bipartite.matrix import biadjacency_matrix
