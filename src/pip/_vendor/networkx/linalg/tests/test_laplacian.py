...
from pip._vendor.networkx.generators.degree_seq import havel_hakimi_graph
from pip._vendor.networkx.generators.expanders import margulis_gabber_galil_graph
